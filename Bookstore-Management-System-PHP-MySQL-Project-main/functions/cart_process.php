    ...
    function display() 
    {
            ...
            foreach ($_SESSION['cart'] as $id => $value) 
            {
                ...
                echo '
                    <tr>
                        ...
                        <td>' . $value['price'] . '</td>
                        <td>' . $rate . '</td>
                        <td><a class="btn btn-outline-danger" href="../Bookstore-Management-System-PHP-MySQL-Project-main/functions/add_to_cart.php?id=' . $id . '">Delete</a></td>
                    </tr>';
        ...
        echo '
            ...
            <div align="center" style="margin-top: 20px">
                ...
                <a class="btn btn-outline-success btn-sm" href="../Bookstore-Management-System-PHP-MySQL-Project-main/order.php" name="button" >Confirm & Submit Order</a>     
            </div>';
